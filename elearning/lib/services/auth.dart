...
class ProfileAPI {
   static Future<Map<String, dynamic>> fetchProfileData(String token) async {
    ...
    try {
      ...
      final response = await http.get(Uri.parse('${Constants.baseUrl}/webservice/rest/server.php?moodlewsrestformat=json&wstoken=$token&wsfunction=local_corporate_api_create_profileapi&userid=$userId'));
