...
class MLPopup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      child: contentBox(context, screenSize).asGlass(
  ...
  Widget contentBox(BuildContext context, Size screenSize) {
  return Container(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        SizedBox(width: 2.0),
                        Text(
                          'Start Date:${courseStartDate ?? "N/A"}',
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => CourseDetailsPage(token, course_id, course_name),
                    ),
                  );
                },
                style: ElevatedButton.styleFrom(
